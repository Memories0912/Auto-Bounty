                ...
                if not CheckAllSeaMonster() and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
                    ...
                    if GetBoat(Func_SeaEvent["Boat Name"]) and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
                        ...
                        if not game.Players.LocalPlayer.Character.Humanoid.Sit then
                            getCurrentOwnerBoat.VehicleSeat.CFrame = Zone6_CFrame * CFrame.new(20,0,0)
                            wait(0.6)
            ...
            if CheckStatusFeature(Func_SeaEvent["Auto Kill Ghost/Fish Ship"]) == "TRUE" then
                if GetGhostShip() then
                    repeat task.wait()
                        ...
                        if GetDistance(GetGhostShip().VehicleSeat.CFrame) <= 70 then
                            SpamSkill(true)
                        else
                            SpamSkill(false)
                        end
                        ToTween(GetGhostShip().VehicleSeat.CFrame * CFrame.new(0,-1,2))
                        getgenv().AimPos = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0,-5,0)
                        getgenv().Aim = true
                ...
                if GetFishShip() then
                    repeat task.wait()
                        ...
                        if GetDistance(GetFishShip().VehicleSeat.CFrame) <= 70 then
                            SpamSkill(true)
                        else
                            SpamSkill(false)
                        end
                        ToTween(GetFishShip().VehicleSeat.CFrame * CFrame.new(0,-1,2))
                        getgenv().AimPos = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0,-5,0)
                        getgenv().Aim = true
